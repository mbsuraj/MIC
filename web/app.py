...
def main():
    ...
    st.markdown('<p style="text-align: center; font-size: 1.3rem; color: #555; font-weight: 500;">Decision safety for small-data businesses</p>', unsafe_allow_html=True)
    ...
    # Progress bar
    progress = min((st.session_state.step - 1) / 3, 1.0)  # 3 steps total, cap at 1.0
